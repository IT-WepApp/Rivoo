...
class SessionMonitorService {
  ...
  static const int _defaultInactivityTimeoutMinutes = 30; // مدة عدم النشاط بالدقائق
  ...
  Future<void> setSessionExpiry({int expiryDays = _defaultSessionExpiryDays}) async {
  ...
  Future<int> getInactivityTimeout() async {
    final prefs = await SharedPreferences.getInstance();
    return prefs.getInt(_inactivityTimeoutKey) ?? _defaultInactivityTimeoutMinutes;
  }
