...
class AuthNotifier extends StateNotifier<DeliveryPersonModel?> {
  ...
  AuthNotifier(this._authService /*, this._deliveryPersonService*/) : super(null); 
    ...
    try {
      ...
      if (firebaseUser != null) {
        ...
        state = DeliveryPersonModel(
            ...
            vehicleDetails: 'Placeholder Vehicle', // Placeholder - fetch actual details
          );
        return true;
      } else {
        state = null;
...
final authNotifierProvider = StateNotifierProvider<AuthNotifier, DeliveryPersonModel?>((ref) {
