...
void main() {
  group('ThemeToggleWidget Tests', () {
    testWidgets('يجب أن يعرض خيارات السمة الثلاثة',
      ...
      expect(
          find.byIcon(Icons.wb_sunny), findsOneWidget); // أيقونة الوضع الفاتح
      expect(find.byIcon(Icons.nightlight_round),
          findsOneWidget); // أيقونة الوضع الداكن
      expect(find.byIcon(Icons.settings_suggest),
          findsOneWidget); // أيقونة إعدادات النظام
    });

    testWidgets('يجب أن يتم تحديد وضع السمة الحالي',
        (WidgetTester tester) async {
      // بناء الواجهة للاختبار
      await tester.pumpWidget(
        const ProviderScope(
    ...
    testWidgets('يجب أن يتم تغيير وضع السمة عند النقر على وضع آخر',
        (WidgetTester tester) async {
      // بناء الواجهة للاختبار
      await tester.pumpWidget(
        const ProviderScope(
