...
Future<String?> authGuard(BuildContext context, GoRouterState state) async { // Added BuildContext
...
final appRouter = GoRouter(
  ...
  routes: [
    GoRoute(
      path: '/', // Login Page
      builder: (context, state) => const AdminLoginPage(), // Assuming this is the main entry/login
    ),
    GoRoute(
       path: '/adminHome', // Admin Dashboard
       builder: (context, state) => const AdminHomePage(),
       routes: [ // Nested routes accessible from the admin home/dashboard
         GoRoute(
           path: 'categoryManagement', // Relative path: /adminHome/categoryManagement
