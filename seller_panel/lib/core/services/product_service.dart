...
class ProductService {
  ...
  Future<List<Map<String, dynamic>>> getSellerProducts() async {
    ...
    final snapshot = await _firestore.collection(AppConstants.productsCollection)
  ...
  Future<Map<String, dynamic>?> getProduct(String productId) async {
    final doc = await _firestore.collection(AppConstants.productsCollection)
        .doc(productId)
        .get();
  ...
  Future<String> addProduct(Map<String, dynamic> productData) async {
    ...
    final docRef = await _firestore.collection(AppConstants.productsCollection).add(productData);
    return docRef.id;
  }
  ...
  Future<void> updateProduct(String productId, Map<String, dynamic> productData) async {
    ...
    await _firestore.collection(AppConstants.productsCollection)
        .doc(productId)
        .update(productData);
  }
  ...
  void _validateProductData(Map<String, dynamic> productData) {
    ...
    if (productData['price'] == null || (productData['price'] is num && productData['price'] <= 0)) {
    ...
    if (productData['description'] == null || productData['description'].toString().isEmpty) {
...
// مزود منتج محدد
final productProvider = FutureProvider.family<Map<String, dynamic>?, String>((ref, productId) async {
  final productService = ref.watch(productServiceProvider);
