...
class NotificationService {
  ...
  Future<void> initialize(String? storeId) async {
    ...
    try {
      ...
      log('Error initializing NotificationService',
          error: e, stackTrace: stacktrace, name: 'NotificationService');
    }
  }
    ...
    if (notification != null && android != null) {
      _localNotifications.show(
          ...
          payload: message.data.isNotEmpty
              ...
              : null // Use message data as payload
          );
    }
  }
  ...
  Future<void> unsubscribeFromStoreTopic(String? storeId) async {
    if (storeId != null && storeId.isNotEmpty) {
      try {
        ...
        log('Error unsubscribing from topic',
            error: e, stackTrace: stacktrace, name: 'NotificationService');
      }
    }
  }
