  ...
  static void testProductService() {
    group('ProductService Tests', () {
      ...
      test('Get products should return list of products', () async {
        ...
        when(mockProductService.getProducts()).thenAnswer((_) async => mockProducts);
      ...
      test('Get product by ID should return correct product', () async {
        ...
        when(mockProductService.getProductById('1')).thenAnswer((_) async => mockProduct);
      ...
      test('Add product should succeed', () async {
        ...
        when(mockProductService.addProduct(mockProduct)).thenAnswer((_) async => '3');
      ...
      test('Update product should succeed', () async {
        ...
        when(mockProductService.updateProduct('1', mockProduct)).thenAnswer((_) async => true);
      ...
      test('Delete product should succeed', () async {
        // Arrange
        when(mockProductService.deleteProduct('1')).thenAnswer((_) async => true);
  ...
  static void testOrderService() {
    group('OrderService Tests', () {
      ...
      test('Get order by ID should return correct order', () async {
        ...
        when(mockOrderService.getOrderById('1')).thenAnswer((_) async => mockOrder);
      ...
      test('Update order status should succeed', () async {
        // Arrange
        when(mockOrderService.updateOrderStatus('1', 'processing')).thenAnswer((_) async => true);
        
        // Act
        final result = await mockOrderService.updateOrderStatus('1', 'processing');
      ...
      test('Get seller sales statistics should return statistics data', () async {
        // Arrange
        ...
        when(mockOrderService.getSellerSalesStatistics(timeRange: 'week')).thenAnswer((_) async => mockStatistics);
        
        // Act
        final result = await mockOrderService.getSellerSalesStatistics(timeRange: 'week');
        
        // Assert
        expect(result, mockStatistics);
        verify(mockOrderService.getSellerSalesStatistics(timeRange: 'week')).called(1);
      });
    });
  }
  ...
  static void testNotificationService() {
    group('NotificationService Tests', () {
      ...
      test('Get notifications should return list of notifications', () async {
        ...
        when(mockNotificationService.getNotifications()).thenAnswer((_) async => mockNotifications);
      ...
      test('Mark notification as read should succeed', () async {
        // Arrange
        when(mockNotificationService.markAsRead('1')).thenAnswer((_) async => true);
      ...
      test('Delete notification should succeed', () async {
        // Arrange
        when(mockNotificationService.deleteNotification('1')).thenAnswer((_) async => true);
      ...
      test('Send FCM token should succeed', () async {
        ...
        when(mockNotificationService.sendFCMToken(mockToken)).thenAnswer((_) async => true);
