...
class ProductNotifier extends StateNotifier<AsyncValue<List<Product>>> {
  ...
  ProductNotifier(this._productService, [this._storeId])
  ...
  Future<void> fetchProducts() async {
    ...
    try {
      ...
      log('Error fetching products',
          error: e, stackTrace: stacktrace, name: 'ProductNotifier');
      // mounted check removed
...
final allProductsProvider = StateNotifierProvider.autoDispose<ProductNotifier,
    AsyncValue<List<Product>>>((ref) {
  final productService =
      ref.watch(productServiceProvider); // Use productServiceProvider
