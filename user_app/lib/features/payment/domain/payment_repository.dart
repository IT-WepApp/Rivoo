...
abstract class PaymentRepository {
  ...
  Future<Either<Failure, List<PaymentMethodEntity>>> getAvailablePaymentMethods();
  
  /// الحصول على طرق الدفع المحفوظة للمستخدم
  Future<Either<Failure, List<PaymentMethodEntity>>> getSavedPaymentMethods();
  
  /// حفظ طريقة دفع جديدة
  Future<Either<Failure, PaymentMethodEntity>> savePaymentMethod(PaymentMethodEntity paymentMethod);
