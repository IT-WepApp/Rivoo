      ...
      body: ordersAsyncValue.when(
        data: (orders) {
          if (orders.isEmpty) {
            ...
            if (userId == null) {
              return const Center(child: Text('يرجى تسجيل الدخول لعرض طلباتك.'));
            } else {
              return Center(
                child: Column(
                  ...
                  children: [
                    ...
                    const Text("لم تقم بإجراء أي طلبات بعد.", style: TextStyle(fontSize: 18)),
                    const SizedBox(height: 16),
                    AppButton(
                      text: 'تصفح المنتجات',
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                const SizedBox(width: 8),
                                Text('المجموع: ${totalPrice.toStringAsFixed(2)} ريال'),
                              ],
                            ),
