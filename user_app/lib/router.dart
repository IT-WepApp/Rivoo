      ...
      case '/product':
        return MaterialPageRoute(
          builder: (context) => ProductDetailsScreen(
            productId: (settings.arguments as Map<String, dynamic>)['productId']
                as String,
          ),
          settings: settings,
        );
      ...
      case '/order':
        return AuthGuardRoute(
          builder: (context) => OrderTrackingPage(
            orderId: (settings.arguments as Map<String, dynamic>)['orderId']
                as String,
          ),
          settings: settings,
          requiredRoles: ['customer', 'admin'],
      ...
      case '/support/ticket':
        return AuthGuardRoute(
          builder: (context) => TicketDetailsScreen(
            ticketId: (settings.arguments as Map<String, dynamic>)['ticketId']
                as String,
          ),
          settings: settings,
        );
