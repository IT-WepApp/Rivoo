  ...
  Widget build(BuildContext context) {
    ...
    switch (deviceType) {
      ...
      case DeviceType.smallTablet:
        return smallTabletBuilder?.call(context) ?? mobileBuilder(context);
...
class ResponsiveWidth extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // حساب العرض المتجاوب
    final widthRatio =
        ResponsiveUtils.getResponsiveWidthRatio(context, baseWidthRatio);
  ...
  Widget build(BuildContext context) {
    ...
    final responsiveFontSize = baseStyle!.fontSize != null
        ? ResponsiveUtils.getResponsiveFontSize(
            context, baseStyle.fontSize! * scaleFactor)
        : null;
...
class ResponsiveGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final responsiveSpacing =
        spacing * ResponsiveUtils.getResponsiveScale(context);
...
class ResponsiveButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final responsiveHeight =
        ResponsiveUtils.getResponsiveHeight(context, baseHeight);
