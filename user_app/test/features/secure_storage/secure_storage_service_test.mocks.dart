...
// in user_app/test/features/secure_storage/secure_storage_service_test.dart.
...
import 'package:user_app/core/utils/encryption_utils.dart' as _i5;
...
/// A class which mocks [EncryptionUtils].
///
/// See the documentation for Mockito's code generation for more information.
class MockEncryptionUtils extends _i1.Mock implements _i5.EncryptionUtils {
  MockEncryptionUtils() {
    _i1.throwOnMissingStub(this);
  }

  @override
  String getSecretKey() => (super.noSuchMethod(
        Invocation.method(
          #getSecretKey,
          [],
        ),
  ...
  @override
  String decrypt(String? encryptedText) => (super.noSuchMethod(
        Invocation.method(
          #decrypt,
          [encryptedText],
        ),
