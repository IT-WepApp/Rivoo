...
class AppColors {
  ...
  static const Color textPrimaryDark = Color(0xFFE1E1E1); // لون النص الأساسي في الوضع الداكن
  static const Color textSecondaryDark = Color(0xFFB0B0B0); // لون النص الثانوي في الوضع الداكن
  ...
  static const Color dividerDark = Color(0xFF424242);   // لون الفواصل في الوضع الداكن
  static const Color border = Color(0xFFBDBDBD);        // لون الحدود
  static const Color borderDark = Color(0xFF616161);    // لون الحدود في الوضع الداكن
